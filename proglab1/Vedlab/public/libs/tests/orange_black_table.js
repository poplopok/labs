...
function start_test() {
    ...
    document.getElementById('Choosing_instruction').innerHTML = '<b style="color: orange">Оранжевые на увеличение</b><b style="color: black"> Черные на уменьшение</b>';
